...
e = [w for w in wordlist if re.search(r'([^aeiou][aeiou][^aeiou])*', w)]  # alle Wörter mit einem Umlaut ind er Mitte, OHNE Umlaut davor und mit variabel vielen Nicht-Umlauten danach
